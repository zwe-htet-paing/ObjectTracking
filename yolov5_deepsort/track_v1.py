...
def run(
        ...
        config_deepsort=ROOT / 'trackers/deep_sort/configs/deep_sort.yaml',
    ...
    if not isinstance(yolo_weights, list):  # single yolo model
        ...
        exp_name = 'ensemble'
    exp_name = name if name else exp_name + "_" + deep_sort_weights.stem
    ...
    if webcam:
        ...
        bs = len(dataset) # nr_source batch size
    else:
    ...
    for i in range(bs):
        deepsort_list.append(
            DeepSort(cfg.DEEPSORT.MODEL_TYPE,
...
def parse_opt():
    ...
    parser.add_argument('--config-deepsort', type=str, default='trackers/deep_sort/configs/deep_sort.yaml')
