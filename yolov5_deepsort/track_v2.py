...
def detect(opt):
    ...
    # config_deepsort = opt.config_deepsort
    webcam = source == '0' or source.startswith(
        'rtsp') or source.startswith('http') or source.endswith('.txt')

    # Initialize deepsort
    deepsort = create_tracker("deepsort")
...
if __name__ == '__main__':
    ...
    parser.add_argument("--config_deepsort", type=str, default="trackers/deep_sort/configs/deep_sort.yaml")
